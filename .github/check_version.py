...
Check version number in setup.json and aiida_hightc/__init__.py and make sure
they match.
"""
...
import aiida_hightc  # pylint: disable=wrong-import-position
version = aiida_hightc.__version__

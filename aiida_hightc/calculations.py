"""
Calculations provided by aiida_hightc.
...
DiffParameters = DataFactory('hightc')
...
class DiffCalculation(CalcJob):
    ...
    def define(cls, spec):
        ...
        spec.inputs['metadata']['options']['parser_name'].default = 'hightc'
        ...
        spec.output('hightc', valid_type=SinglefileData, help='diff between file1 and file2.')
